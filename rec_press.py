...
class Dislocations:
    ...
    def austenite_disl_dens(self, d_s=0, T=1.0, C=0.0):
        ...
        return pow(d_s /(self.parameters["ALPHA_DISL"]["intercept"]*self.parameters["tailor"]["intercept"]*mu*b[0]), 2.0)
    ...
    def disl_dens_decr_austenite(self, s_0=1.0, d_s=0.0, T=1000.0, C=0.1, tau=0.0, n_total=0, n_init=1):
        ...
        a_p = self.parameters["ALPHA_DISL"]["intercept"]
        M = self.parameters["tailor"]["intercept"]
